...
import edu.sau.utils.PrintUtils;
...
public class KarumanchiTester {
	...
	private static void findCeiledFractionalNode() {
		...
		Node<Integer> ceiledFractionalNode = linkedList.findCeiledFractionalNode(5);
	...
	private static void findLastModularNodeForConstant() {
		...
		Node<String> lastModularNode = linkedList.findLastModularNodeForConstant(7);
	...
	private static void cloneListWithRandomPointer() {
		...
		Node<String> node6 = new Node<>("6");
		Node<String> node7 = new Node<>("7");
		node1.setRandom(node6);
		node2.setRandom(node5);
		node3.setRandom(node2);
		node4.setRandom(node3);
		node5.setRandom(node5);
		node6.setRandom(node4);
		node7.setRandom(node1);
	...
	private static void findNthNodeFromEndOfListUsingSizeOfList(int n) {
		LinkedList<Integer> linkedList = new LinkedList<>();
		linkedList.insert(1);
		linkedList.insertAtEnd(2);
		linkedList.insertAtEnd(3);
		...
		linkedList.insertAtEnd(5);
		linkedList.traverseList();
		System.out.println(PrintUtils.ordinalSuffixOf(n) + " element from end of list is: "
				+ linkedList.findNthNodeFromEndOfListUsingSizeOfList(n));
		System.out.println();
	}

	private static void findNthNodeFromEndOfListWithoutUsingSizeOfList(int n) {
		LinkedList<String> linkedList = new LinkedList<>();
		linkedList.insert("a");
